...
**Authors:** `[FINAL AUTHOR LIST TO BE CONFIRMED]`
...
Citation metadata are maintained in [`CITATION.cff`](CITATION.cff). The final release will support four related citation targets without treating any placeholder as an existing identifier:

- **Manuscript:** author list, journal, year, and article DOI to be confirmed.
